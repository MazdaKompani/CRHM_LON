...
crhm_col_QSurf = 25; % col including time
...
for i=1:numel(model_tests(:,1))
   ...
   h1 = axes;
    plot(QTile,'ro','Markersize',2)        %change from QSurf to  QTile
    hold on
    ...
    % Performence calculation
     [Nash,RMSE,Bias] = PerformenceCalculator(QSurf_crhm_i.Time,QSurf_crhm_i.Data,...
         QTile.Time,QTile.Data);   %chnage QSurf   to QTile
